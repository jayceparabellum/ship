...
2. Elastic Beanstalk runs the Express API and WebSocket server.
...
The API deploys to Elastic Beanstalk as a Dockerized Express application with WebSocket support through the ALB.
...
EB_APP_NAME=ship-api
EB_ENV_NAME=ship-api-dev
