...
import securityToolRoutes from './routes/security-tool.js';
...
export function createApp(corsOrigin: string = 'http://localhost:5173'): express.Express {
  ...
  // Security tool report routes - read-only super-admin dashboard data
  app.use('/api/security-tool', securityToolRoutes);
